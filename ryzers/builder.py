...
class DockerBuilder:
    """
    A class to build Docker/Podman images sequentially from a list of Dockerfiles.
    """
    ...
    def __init__(self, container_name: str, packages: List[str]):
        ...
        :param base_image: Base image to use for the builds.
        """
    ...
    def build(self, dockerfiles: List[str], buildflags: List[str], initial_image: str):
        ...
        for index, dockerfile_path in enumerate(dockerfiles):
            ...
            # Build the image with the current base image
